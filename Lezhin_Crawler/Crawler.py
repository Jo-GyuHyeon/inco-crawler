...
class Lezhin_crawler:
    ...
    def accessDayWebToon(self, day):
        ...
        intergerDay = day
        real_webtoonList = []
        dayList = [None, "1", "2", "3", "4", "5", "6", "0", "n", "c"]
        ...
        for i in range(1, len(count)+1):
            webtoon_selector = "#comic-scheduled-day-%s > li:nth-child(%d) > a > div.homelist-thumb" %(day, i)
    ...
    def getInWebToon(self, day):
        ...
        #제목
        name_selector = "#cover-info > div.cover-info-wrap > div.info > h2"

        #설명
        introduce_selector = """//*[@id="product-synopsis"]/p[2]"""

        #썸네일
        thumbnail_selector = "#cover-info > div.cover-info-wrap > div.banner-wrap > div > img"

        #장르
        genre_selector ="#cover-info > div.cover-info-wrap > div.info > div.genre > .genre-link"

        #작가
        writer_selector = " #cover-info > div.cover-info-wrap > div.info > p > a"
    ...
    def isDayChange(self, WebtoonVO):
        ...
        for i in range(1,9):
            flag = 0
            day = dayList[i]
            driver.find_element_by_css_selector("#comic-scheduled__tab--%s" %dayList[i]).click()
            wb_name = driver.find_elements_by_css_selector("#comic-scheduled-day-%s > li > a > div.homelist-title > span" %day)
            ...
            for j in range(1, len(wb_name)+1):
                if wb_name[j-1].text == WebtoonVO.webtoonName:
                    ...
                    change_day = change_day + dayString[i] + " "
